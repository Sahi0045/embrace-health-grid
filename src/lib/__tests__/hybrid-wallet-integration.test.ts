...
describe("Hybrid Wallet Signing Integration", () => {
  ...
  describe("Transaction Router Decision Logic", () => {
    it("routes to Phantom when preferred and available", async () => {
      ...
      const { determineSigningPath } = await import("@/lib/hybrid-wallet-integration.server");
  ...
  describe("Error Recovery and Retry Logic", () => {
    ...
    it("falls back to embedded on Phantom failure", async () => {
      ...
      const { handleSigningError } = await import("@/lib/hybrid-wallet-integration.server");
  ...
  describe("Audit Trail Recording", () => {
    it("records successful Phantom signing to audit", async () => {
      ...
      const { recordWalletSigningAudit } = await import("@/lib/wallet-audit-integration.server");
  ...
  describe("Pharmacy Dispensing with Blockchain", () => {
    it("completes dispensing and blockchain signing", async () => {
      ...
      const { dispensePrescriptionMedicationsWithBlockchain } =
        await import("@/lib/pharmacy-wallet-integration.server");
  ...
  describe("Compliance Verification", () => {
    it("verifies valid blockchain signature", async () => {
      const { verifyWalletSigningChain } = await import("@/lib/wallet-audit-integration.server");
    ...
    it("generates compliance report", async () => {
      const { generateWalletSigningComplianceReport } =
        await import("@/lib/wallet-audit-integration.server");
