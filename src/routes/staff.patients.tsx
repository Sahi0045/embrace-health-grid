          ...
          >
            ...
            <div className="p-6 space-y-5">
              ...
              {isAdmin &&
                selected &&
                (() => {
                  const patientCardEntry = nfcCards.find(
                    (c: any) => c.value?.patientDid === selected.did,
                  );
                    ...
                    <Card className="border-primary/20 shadow-clinical">
                      <CardHeader className="pb-2">
                        <div className="flex items-center gap-2">
                          ...
                          {patientCard ? (
                            <span
                              className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-semibold ml-auto ${patientCard.status === "active" ? "bg-success/10 text-success" : "bg-destructive/10 text-destructive"}`}
                            >
              ...
              {prescriptions.map((rx: any) => (
                <div key={rx.rxId} className="rounded-lg border p-3 text-xs space-y-2 bg-card">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge
                      variant="outline"
                      className="bg-success/5 text-success border-success/20 text-[9px] flex items-center gap-1"
                    >
