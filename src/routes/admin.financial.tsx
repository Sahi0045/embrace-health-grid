...
import {
  getUsers as adminGetLivePatients,
  getBilling as adminGetTransactions,
  payBill as recordPayment,
  getBilling as getNamespace,
  type LivePatient,
...
export const Route = createFileRoute("/admin/financial")({
  ...
  component: AdminFinancialPageGuarded,
});
...
function AdminFinancialPage() {
  ...
  const refresh = useCallback(() => {
    ...
    getNamespace()
      ...
      .then((res) => setBillingRecords(res.payments ?? []))
      .catch(() => {});
  }, []);
 ...
 */
function AdminFinancialPageGuarded() {
  return (
    <RouteGuard requiredRole="admin">
      <AdminFinancialPage />
    </RouteGuard>
