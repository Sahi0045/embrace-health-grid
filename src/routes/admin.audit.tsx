        ...
        <div className="flex gap-2 shrink-0">
          ...
          {stats?.pendingAnchors > 0 && (
            <button
              ...
              disabled={anchoring}
              className="inline-flex items-center gap-1.5 rounded-xl bg-warning px-3 py-2 text-xs font-semibold text-warning-foreground hover:bg-warning/90 disabled:opacity-50"
            >
