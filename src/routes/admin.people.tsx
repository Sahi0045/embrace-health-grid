...
import { useLivePatients, useLiveStaff } from "@/hooks/use-admin";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export const Route = createFileRoute("/admin/people")({
  ...
  component: PeopleManagementGuarded,
});
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <Badge className={getStatusColor(doctor.status ?? "unknown")}>
                          {doctor.status}
                        </Badge>
                      </div>
                    </div>
                    ...
                    <div className="mt-3 grid gap-2 text-sm sm:grid-cols-3">
                      ...
                      <div className="rounded-lg bg-muted p-2">
                        ...
                        <div className="text-xs">
                          {new Date(staff.joinedDate ?? Date.now()).toLocaleDateString()}
                        </div>
                      </div>
                    </div>
                  </CardContent>
 ...
 */
function PeopleManagementGuarded() {
  return (
    <RouteGuard requiredRole="admin">
      <PeopleManagement />
    </RouteGuard>
