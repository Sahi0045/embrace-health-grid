...
import {
  ...
  useLivePatients,
  useAdminAmbulances as useAmbulances,
...
export const Route = createFileRoute("/admin/digital-twin")({
  ...
  component: DigitalTwinPageGuarded,
});
  ...
  const dynamicTree = useMemo<TwinNode>(() => {
    ...
    const cardiologyWardBeds = liveBeds
      ...
      .map((b: any) => {
        ...
        // `as TwinNode[]` because the inline literals widen `type` to string.
        const patientNode = (
 ...
 */
function DigitalTwinPageGuarded() {
  return (
    <RouteGuard requiredRole="admin">
      <DigitalTwinPage />
    </RouteGuard>
