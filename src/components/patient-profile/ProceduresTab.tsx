        ...
        {allItems.map((item) => (
          <GlowCard key={item.id} className="p-5 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs bg-background/60 p-3 rounded-xl border border-border/60">
              <div>
                <span className="text-[10px] font-extrabold uppercase text-muted-foreground block">Location / OR</span>
              ...
              <div>
                <span className="text-[10px] font-extrabold uppercase text-muted-foreground block">Surgeon / Clinician</span>
                <span className="font-bold text-foreground flex items-center gap-1 mt-0.5">
